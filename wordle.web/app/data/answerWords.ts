// Common, modern 5-letter words used as answer words (~2300 words)
// These are words most people would know and recognize
export const answerWords: string[] = [
  ...
  'agony', 'agree', 'ahead', 'aider', 'aisle', 'alarm', 'album', 'alert', 'alibi', 'alien',
  ...
  'belly', 'below', 'bench', 'beret', 'berry', 'berth', 'beset', 'betel', 'bevel', 'bible',
  'bible', 'bicep', 'biddy', 'bigot', 'bilge', 'billy', 'binge', 'bingo', 'biome', 'birch',
  'birth', 'bison', 'bitty', 'black', 'blade', 'blame', 'bland', 'blank', 'blare', 'blast',
  'blaze', 'bleak', 'bleat', 'bleed', 'bleep', 'blend', 'bless', 'blimp', 'blind', 'blini',
  'blink', 'bliss', 'blitz', 'bloat', 'block', 'bloke', 'blond', 'blood', 'bloom', 'blown',
  'blues', 'bluff', 'blunt', 'blurb', 'blurt', 'blush', 'board', 'boast', 'bobby', 'boded',
  'bogey', 'boggy', 'bogie', 'bongo', 'bonus', 'booby', 'boost', 'booth', 'booty', 'booze',
  'boozy', 'borax', 'bored', 'borne', 'bosom', 'bossy', 'botch', 'bough', 'boule', 'bound',
  ...
  'dross', 'drove', 'drown', 'drugs', 'druid', 'drunk', 'dryer', 'dryly', 'duchy', 'dully',
  'dummy', 'dumpy', 'dunce', 'dunes', 'dusty', 'dutch', 'duvet', 'dwarf', 'dwell', 'dwelt',
  // E
  ...
  'hunky', 'hurry', 'husky', 'hussy', 'hutch', 'hydra', 'hyena', 'hymen', 'hyper',
  // I
  'icily', 'icing', 'ideal', 'idiom', 'idiot', 'idler', 'idyll', 'igloo', 'iliac', 'image',
  'imbue', 'impel', 'imply', 'inane', 'inbox', 'incur', 'index', 'inept', 'inert', 'infer',
  'infra', 'ingot', 'inlay', 'inlet', 'inner', 'input', 'inter', 'intro', 'ionic', 'irate',
  'irony', 'islet', 'issue', 'itchy', 'ivory',
  // J
  'jaunt', 'jazzy', 'jeans', 'jelly', 'jenny', 'jerky', 'jesus', 'jewel', 'jiffy', 'jiggy',
  'jimmy', 'jingo', 'jinni', 'joker', 'jolly', 'joust', 'judge', 'juice', 'juicy', 'jumbo',
  'jumpy', 'junco', 'junky', 'juror', 'junta',
  // K
  'kabob', 'karma', 'kayak', 'kazoo', 'kebab', 'khaki', 'kinky', 'kiosk', 'kitty', 'knack',
  ...
  'lofty', 'logic', 'login', 'loopy', 'loose', 'lordy', 'loser', 'louse', 'lousy', 'lover',
  ...
  'minor', 'minty', 'minus', 'mirth', 'miser', 'missy', 'misty', 'miter', 'mitre', 'mixed',
  ...
  'musty', 'myrrh',
  // N
  'nacho', 'naive', 'nanny', 'nasal', 'nasty', 'natal', 'naval', 'navel', 'needy', 'neigh',
  'nerdy', 'nerve', 'never', 'newer', 'newly', 'nicer', 'niche', 'niece', 'night', 'ninja',
  'ninny', 'ninth', 'nitty', 'noble', 'nobly', 'noise', 'noisy', 'nomad', 'noose', 'north',
  'nosey', 'notch', 'noted', 'novel', 'nudge', 'nurse', 'nutty', 'nylon', 'nymph',
  // O
  'oaken', 'oakum', 'oasis', 'occur', 'ocean', 'octet', 'odder', 'oddly', 'offal',
  'offer', 'often', 'oiled', 'oiler', 'olden', 'older', 'olive', 'ombre', 'omega', 'onion',
  'onset', 'opera', 'opine', 'opium', 'optic', 'orbit', 'order', 'organ', 'other', 'ought',
  'ounce', 'outdo', 'outer', 'outgo', 'ovary', 'ovate', 'overt', 'ovoid', 'ovule', 'owing',
  'owner', 'oxide', 'ozone',
  // P
  'paddy', 'pagan', 'paint', 'paler', 'palsy', 'panel', 'panic', 'pansy', 'papal', 'paper',
  'parer', 'paris', 'parry', 'parse', 'party', 'pasta', 'paste', 'pasty', 'patch', 'patio',
  'patsy', 'patty', 'pause', 'payee', 'payer', 'peace', 'peach', 'pearl', 'pecan', 'pedal',
  'penal', 'pence', 'penny', 'perch', 'peril', 'perky', 'pesky', 'pesto', 'petal', 'petty',
  'phase', 'phone', 'phony', 'photo', 'piano', 'picky', 'piece', 'piety', 'piggy', 'pilot',
  'pinch', 'piney', 'pinky', 'pinto', 'piper', 'pique', 'pitch', 'pithy', 'piton', 'pivot',
  'pixel', 'pixie', 'pizza', 'place', 'plaid', 'plain', 'plait', 'plane', 'plank', 'plant',
  'plate', 'plaza', 'plead', 'pleat', 'plied', 'plonk',
  'pluck', 'plumb', 'plume', 'plump', 'plunk', 'plush', 'poach', 'point', 'poise', 'poker',
  'polar', 'polka', 'polyp', 'pooch', 'poppy', 'porch', 'porky', 'poser', 'posit', 'posse',
  'pouch', 'pound', 'pouty', 'power', 'prank', 'prawn', 'preen', 'press', 'price', 'prick',
  'pride', 'pried', 'prime', 'primo', 'print', 'prior', 'prism', 'privy', 'prize', 'probe',
  'promo', 'prone', 'prong', 'proof', 'prose', 'proud', 'prove', 'prowl', 'proxy', 'prude',
  'prune', 'psalm', 'pubic', 'pudgy', 'pulse', 'punch', 'pupal', 'pupil', 'puppy', 'puree',
  ...
  'quota', 'quote',
  // R
  'rabbi', 'rabid', 'racer', 'radar', 'radii', 'radio', 'radon', 'rafts', 'rainy', 'raise',
  'rajah', 'rally', 'ralph', 'ramen', 'ranch', 'randy', 'range', 'rapid', 'rarer', 'raspy',
  'ratio', 'ratty', 'raven', 'rayon', 'razor', 'reach', 'react', 'ready', 'realm', 'reams',
  'rebel', 'rebut', 'recap', 'recur', 'redux', 'reedy', 'refer', 'regal', 'rehab', 'reign',
  ...
  'riser', 'risky', 'ritzy', 'rival', 'river', 'rivet', 'roach', 'roast', 'robin', 'robot',
  'rocky', 'rodeo', 'roger', 'rogue', 'roomy', 'roost', 'roots', 'rotor', 'rouge', 'rough',
  'round', 'rouse', 'route', 'rover', 'rowdy', 'rower', 'royal', 'ruddy', 'ruder', 'rugby',
  'ruins', 'ruler', 'rummy', 'rumor', 'rupee', 'rural', 'rusty',
  // S
  'sadly', 'safer', 'saint', 'salad', 'sally', 'salon', 'salsa', 'salty', 'salve', 'salvo',
  'sandy', 'saner', 'sapid', 'sappy', 'sassy', 'satin', 'satyr', 'sauce', 'saucy', 'sauna',
  'saute', 'savor', 'savoy', 'savvy', 'scald', 'scale', 'scalp', 'scaly', 'scamp', 'scant',
  'scare', 'scarf', 'scary', 'scene', 'scent', 'scion', 'scoff', 'scold', 'scone', 'scoop',
  'scoot', 'scope', 'score', 'scorn', 'scout', 'scowl', 'scram', 'scrap', 'scree', 'screw',
  'scrub', 'seamy', 'sedan', 'seedy', 'segue', 'seize', 'semen', 'sense', 'sepia', 'serif',
  'serum', 'serve', 'setup', 'seven', 'sever', 'sewer', 'shade', 'shady', 'shaft', 'shake',
  'shaky', 'shale', 'shall', 'shame', 'shank', 'shape', 'shard', 'share', 'shark', 'sharp',
  ...
  'shred', 'shrew', 'shrub', 'shrug', 'shuck', 'shunt', 'shush', 'sided', 'siege', 'sieve',
  ...
  'spawn', 'speak', 'spear', 'speck', 'speed', 'spell', 'spend', 'spent', 'sperm', 'spice',
  'spicy', 'spied', 'spiel', 'spike', 'spiky', 'spill', 'spine', 'spiny', 'spite',
  'splat', 'split', 'spoil', 'spoke', 'spoof', 'spook', 'spoon', 'spore', 'sport', 'spout',
  ...
  'stout', 'stove', 'strap', 'straw', 'stray', 'strep', 'strip', 'strut', 'stuck', 'study',
  'stuff', 'stump', 'stung', 'stunk', 'stunt', 'style', 'suave', 'sugar', 'suite', 'sulky',
  'sully', 'sumac', 'sunny', 'super', 'surer', 'surge', 'surly', 'sushi', 'swamp', 'swank',
  ...
  'talon', 'tango', 'tangy', 'taper', 'tapir', 'tardy', 'tarot', 'taste', 'tasty', 'tatty',
  'taunt', 'tawny', 'teach', 'teary', 'tease', 'teddy', 'teeth', 'tempo', 'tenet', 'tenor',
  'tense', 'tenth', 'tepee', 'tepid', 'terms', 'terse', 'testy', 'thank', 'theft', 'their',
  ...
  'tried', 'trier', 'trill', 'tripe', 'trite', 'troll', 'tromp', 'troop', 'trope', 'troth',
  'trout', 'trove', 'truce', 'truck', 'truer', 'truly', 'trump', 'trunk', 'truss', 'trust',
  'truth', 'tryst', 'tubal', 'tuber', 'tulip', 'tummy', 'tumor', 'tuner', 'tunic', 'turbo',
  'tutor', 'twain', 'twang', 'tweak', 'tweed', 'tweet', 'twice', 'twine', 'twirl', 'twist',
  'twixt', 'tying',
  // U
  ...
  'vegan', 'veiny', 'veldt', 'venom', 'venue', 'verge', 'verse', 'verso', 'verve', 'vicar',
  'video', 'vigor', 'villa', 'vinyl', 'viola', 'viper', 'viral', 'virus', 'visit', 'visor',
  'vista', 'vital', 'vivid', 'vixen', 'vocal', 'vodka', 'vogue', 'voice', 'voila', 'vomit',
  'voter', 'vouch', 'vowel', 'vying',
  // W
  'wacky', 'wafer', 'wager', 'wagon', 'waist', 'waive', 'waltz', 'warty', 'washy', 'waste',
  'watch', 'water', 'waver', 'waxen', 'weary', 'weave', 'webby', 'wedge', 'weedy', 'weigh',
  ...
  'wince', 'winch', 'windy', 'wiper', 'wired', 'witch', 'witty', 'woken',
  'woman', 'women', 'woody', 'wooer', 'wooly', 'woozy', 'wordy', 'world', 'worry', 'worse',
  'worst', 'worth', 'would', 'wound', 'woven', 'wrack', 'wrath', 'wreak', 'wreck',
  'wrest', 'wring', 'wrist', 'write', 'wrong', 'wrote', 'wrung', 'wryly',
  // X
  'xenon',
  // Y
  'yacht', 'yahoo', 'yearn', 'yeast', 'yield', 'yodel', 'young', 'youth', 'yummy',
  // Z
  'zebra', 'zesty', 'zonal'
]
